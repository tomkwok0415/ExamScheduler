...
class ExamTimeSlot:
    def __init__(self,visual_art_painting_subject, ratio, initial_duration, break_duration, start_time, subject, form, rest):
        self.form = form
        ...
        self.session_durations, self.session_count, self.break_count, self.total_duration = self.calculate_exam_schedule(
            ratio=ratio, total_exam_time=initial_duration, break_duration=break_duration, form=self.form, rest=rest, subject=subject, visual_art_painting_subject= visual_art_painting_subject)
    ...
    def calculate_exam_schedule(self, ratio, total_exam_time, break_duration, form, rest, subject, visual_art_painting_subject):
        """
...
if __name__ == "__main__":
    time_slot = ExamTimeSlot(visual_art_painting_subject = "VA (畫畫部分)", ratio=1.25, initial_duration=120, break_duration=5, start_time="09:00:00",
                             subject="Math Exam", form=4, rest=45)
    print(time_slot)
    time_slot = ExamTimeSlot(visual_art_painting_subject = "VA (畫畫部分)", ratio=1.25, initial_duration=75, break_duration=5, start_time="09:00:00",
